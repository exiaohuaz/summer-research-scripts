...
CLASSIFIER_PATH = 'fast-MPN-COV-master/Results/Finetune-split_data-mpncovresnet50-MPNCOV-reproduce-lr1.2e-3-bs10/model_best.pth.tar'
IMG_PATH = 'test'

CLASSES = ['back', 'front', 'fronttwo', 'full', 'mid']
