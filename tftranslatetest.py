...
def create_tf_example(item):
  ...
  height = 502 # Image height   #get from actual file
...
def main():
  ...
  with contextlib2.ExitStack() as tf_record_close_stack:
    ...
    for capture in os.listdir("testcaptures"):
      with open(os.path.join("testcaptures", capture), 'r') as f1:
