...
def main():
    ...
    for video_name in os.listdir(args.video_dir):        
        ...
        video_capture = cv2.VideoCapture(os.path.join(args.video_dir, video_name))
        class_label = os.path.splitext(video_name)[0]
        dir_for_frames = os.path.join(args.output_path, class_label)
        os.mkdir(dir_for_frames)
        ...
        while frame is not None:
            ...
            for score, box in zip(scores, boxes):
                ...
                filepath = os.path.join(dir_for_frames, filename)
